...
def extract_nes_from_episodes():
    ...
    seasons_dirs = glob.glob("../generated/pre_processed_documents/*")
...
def create_ne_csv(named_entities):
    ...
    named_entities.sort()
    with open("../generated/ne_extractor_entities.csv", 'w', encoding="utf-8") as file:
...
def create_ne_with_sentence_csv(named_entities):
    ...
    with open("../generated/ne_extractor_entities_with_sentences.csv", 'w', encoding="utf-8") as file:
        for entidade in named_entities:
            file.write("{0},{1}\n".format(entidade[0], entidade[1]))


def create_ne_json(named_entities):
    with open("../generated/ne_extractor_entities.json", 'w', encoding="utf-8") as file:
