...
def create_relations_csv(all_relations):
    with open("../generated/extract_relations_tuples.csv", "w+", encoding="utf-8") as file:
...
def create_relation_names_csv(all_relations):
    ...
    with open("../generated/extract_relations_relations.csv", "w+", encoding="utf-8") as file:
...
def main():
    with open("../generated/classifica_e_reune_entities.json", "r", encoding="utf-8") as file:
